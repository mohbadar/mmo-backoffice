package af.gov.anar.lib.date.util;

public enum DateUtilConstants {

	ILLEGALARGUMENT_ERROR_CODE("ANAR-UTL-101", "Invalid Argument Found"),
	NULL_ARGUMENT_ERROR_CODE("ANAR-UTL-102", "Null Argument Found"),
	PARSE_EXCEPTION_ERROR_CODE("ANAR-UTL-103", "Parsing error occours");
