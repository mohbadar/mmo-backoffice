...
public class FileUtilityTest {
	...
	public void byteCountToDisplaySizeTest() {
		...
		assertThat(fileUtility.byteCountToDisplaySize(size), is("238 MB"));
	...
	public void checksumNullPOinterTest() throws IOException {
		...
		fileUtility.checksum(null, null);
	...
	public void checksumIllegalArgTest() throws IOException {
		...
		FileUtility.checksum(directory, new CRC32());
	...
	public void checksumIOTest() throws IOException {
		...
		File file = new File("");
		FileUtility.checksum(file, new CRC32());
	...
	public void checksumTest() throws IOException {
		try {
			...
			long cksm = FileUtility.checksum(file, new CRC32()).getValue();
			assertEquals(0, cksm);
		} catch (java.io.IOException e) {
	...
	public void checksumCRC32Test() throws IOException {
		try {
			File file = folder.newFile("sampleFile.txt");
			long cksm = FileUtility.checksumCRC32(file);
			assertEquals(0, cksm);
		} catch (java.io.IOException e) {
			throw new IOException(null, null);
		}
	...
	public void checksumCRC32NullPOinterTest() throws IOException {
		...
		FileUtility.checksumCRC32(null);
	...
	public void checksumCRC32IllegalArgTest() throws IOException {
		...
		FileUtility.checksumCRC32(directory);
	...
	public void checksumCRC32IOTest() throws IOException {
		...
		File file = new File("");
		FileUtility.checksumCRC32(file);
	...
	public void cleanDirectoryIllegalArgTest() throws IOException {
		try {
			File file = folder.newFile("sampleFile.txt");
			FileUtility.cleanDirectory(file);
		} catch (java.io.IOException e) {
			throw new IOException(null, null, e.getCause());
		}
	...
	public void cleanDirectoryIOExceptionTest() throws IOException {
		File dir1 = new File("");
		FileUtility.cleanDirectory(dir1);
	...
	public void contentEqualsTest() throws IOException {
		...
		try {
			...
			assertThat(FileUtility.contentEquals(file1, file2), is(true));
		} catch (java.io.IOException e) {
			throw new IOException(null, null, e.getCause());
		}
	...
	public void contentEqualsIOTest() throws IOException {
		try {
			...
			assertThat(FileUtility.contentEquals(file1, file2), is(false));
		} catch (java.io.IOException e) {
	...
	public void contentEqualsIgnoreEOLTest() throws IOException {
		try {
			File file1 = folder.newFile("file1.txt");
			File file2 = folder.newFile("file2.txt");
			assertThat(FileUtility.contentEqualsIgnoreEOL(file1, file2, null), is(true));
		} catch (java.io.IOException e) {
	...
	public void contentEqualsIgnoreEOLIOTest() throws IOException {
		...
		try {
			...
			FileUtility.contentEqualsIgnoreEOL(file1, file2, null);
		} catch (java.io.IOException e) {
	...
	public void convertFileCollectionToFileArrayTest() throws IOException {
		...
		try {
			...
			assertTrue(Arrays.equals(FileUtility.convertFileCollectionToFileArray(listFile), fileArray));
	...
	public void copyDirectoryTest() throws IOException {
		try {
			...
			FileUtility.copyDirectory(dir1, dir2);
		} catch (java.io.IOException e) {
			throw new IOException(null, null, e.getCause());
		}
	}
	...
	public void copyInputStreamToFileIOTest() throws IOException {
		...
		File file1 = new File("");
		FileUtility.copyInputStreamToFile(istream, file1);
	...
	public void copyToFileIOTest() throws IOException {
		...
		try {
			...
			FileUtility.copyToFile(istream, file1);
		} catch (java.io.IOException e) {
	...
	public void directoryContainsTest() throws IOException {
		try {
			...
			assertFalse(FileUtility.directoryContains(dir, file));
		} catch (java.io.IOException e) {
	...
	public void forceDeleteOnExitTest() throws IOException {
		try {
			File file = folder.newFile("sampleFile.txt");
			FileUtility.forceDeleteOnExit(file);
		} catch (java.io.IOException e) {
	...
	public void isFileNewerTest() {
		try {
			...
			assertTrue(FileUtility.isFileNewer(file, date));
		} catch (java.io.IOException e) {
	...
	public void isFileNewerIllegalArgTest() {
		...
		File file = null;
		Date date = new Date(10000);
		FileUtility.isFileNewer(file, date);
	...
	public void isFileOlderTest() {
		try {
			File file = folder.newFile("sampleFile.txt");
			Date date = new Date(10000);
			assertFalse(FileUtility.isFileOlder(file, date));
		} catch (java.io.IOException e) {
	...
	public void isFileOlderIllegalArgTest() {
		...
		File file = null;
		Date date = new Date(10000);
		FileUtility.isFileOlder(file, date);
	...
	public void isSymlinkTest() throws IOException {
		try {
			File file = folder.newFile("sampleFile.txt");
			assertFalse(FileUtility.isSymlink(file));
		} catch (java.io.IOException e) {
	...
	public void iterateFilesTest() {
		try {
			...
			Iterator<File> fileIt = FileUtility.iterateFiles(directory, TrueFileFilter.INSTANCE, TrueFileFilter.INSTANCE);
			fileIt.hasNext();
		} catch (java.io.IOException e) {
	...
	public void lineIteratorTest() throws IOException {
		try {
			File file = folder.newFile("sampleFile.txt");
			LineIterator lItr = FileUtility.lineIterator(file);
			lItr.hasNext();
		} catch (java.io.IOException e) {
	...
	public void lineIteratorWithEncodingTest() throws IOException {
		try {
			File file = folder.newFile("sampleFile.txt");
			LineIterator lItr = FileUtility.lineIterator(file, "UTF-8");
			lItr.hasNext();
		} catch (java.io.IOException e) {
	...
	public void listFilesTest() {
		...
		try {
			...
			FileUtility.listFiles(directory, TrueFileFilter.INSTANCE, TrueFileFilter.INSTANCE);
		} catch (java.io.IOException e) {
	...
	public void listFilesAndDirsTest() {
		...
		try {
			directory = folder.newFolder("directory");
			FileUtility.listFilesAndDirs(directory, TrueFileFilter.INSTANCE, TrueFileFilter.INSTANCE);
		} catch (java.io.IOException e) {
	...
	public void moveDirectoryFileExistsTest() throws IOException {
		try {
			File dir1 = folder.newFolder("dir1");
			File dir2 = folder.newFolder("dir2");
			FileUtility.moveDirectory(dir1, dir2);
		} catch (java.io.IOException e) {
	...
	public void moveDirectoryIOTest() throws IOException {
		try {
			...
			FileUtility.moveDirectory(dirSource, dirDest);
		} catch (java.io.IOException e) {
	...
	public void moveDirectoryTest() throws IOException {
		try {
			...
			FileUtility.moveDirectory(dirSource, dirDest);
			FileUtility.deleteQuietly(dirDest);
		} catch (java.io.IOException e) {
	...
	public void moveDirectoryToDirectoryIOTest() throws IOException {
		try {
			...
			FileUtility.moveDirectoryToDirectory(dirSource, dirDest, false);
	...
	public void moveFileFileExistsTest() throws IOException {
		try {
			...
			FileUtility.moveFile(srcFile, destFile);
		} catch (java.io.IOException e) {
	...
	public void moveFileTest() throws IOException {
		try {
			...
			FileUtility.moveFile(srcFile, destFile);
			FileUtility.deleteQuietly(destFile);
		} catch (java.io.IOException e) {
	...
	public void moveFileToDirectoryTest() throws IOException {
		try {
			...
			FileUtility.moveFileToDirectory(srcFile, destDir, false);
			FileUtility.deleteQuietly(destDir);
		} catch (java.io.IOException e) {
	...
	public void moveToDirectoryTest() throws IOException {
		try {
			...
			FileUtility.moveToDirectory(srcFile, destDir, false);
			FileUtility.deleteQuietly(destDir);
		} catch (java.io.IOException e) {
	...
	public void openInputStreamTest() throws IOException {
		...
		try {
			...
			FileUtility.openInputStream(file);
	...
	public void openOutputStreamTest() throws IOException {
		...
		try {
			File file = folder.newFile();
			FileUtility.openOutputStream(file);
		} catch (java.io.IOException e) {
	...
	public void openOutputStreamWithAppendTest() throws IOException {
		...
		try {
			File file = folder.newFile();
			FileUtility.openOutputStream(file, true);
		} catch (java.io.IOException e) {
	...
	public void readFileToByteArrayTest() throws IOException {
		...
		try {
			File file = folder.newFile();
			FileUtility.readFileToByteArray(file);
		} catch (java.io.IOException e) {
	...
	public void readFileToStringTest() throws IOException {
		...
		try {
			File file = folder.newFile();
			FileUtility.readFileToString(file, null);
		} catch (java.io.IOException e) {
	...
	public void readLinesTest() throws IOException {
		try {
			File file = folder.newFile();
			FileUtility.readLines(file, Charset.forName("UTF-8"));
		} catch (java.io.IOException e) {
	...
	public void readLinesWithStringEncodingTest() throws IOException {
		try {
			File file = folder.newFile();
			FileUtility.readLines(file, "UTF-8");
		} catch (java.io.IOException e) {
	...
	public void sizeOfTest() {
		try {
			File file = folder.newFile();
			assertEquals(0, FileUtility.sizeOf(file));
		} catch (java.io.IOException e) {
	...
	public void sizeOfDirectoryTest() {
		try {
			...
			assertEquals(0, FileUtility.sizeOfDirectory(dir));
		} catch (java.io.IOException e) {
	...
	public void toFileTest() {
		try {
			FileUtility.toFile(new URL("http://www.example.com/docs/resource1.html"));
	...
	public void toFilesTest() {
		...
		try {
			...
			urls[0] = url1;
			urls[1] = url2;
			File[] file = FileUtility.toFiles(urls);
	...
	public void waitForNullPTest() {
		...
		File file = null;
		assertFalse(FileUtility.waitFor(file, 2));
	...
	public void waitForTest() {
		...
		try {
			...
			assertTrue(FileUtility.waitFor(file, 2));
		} catch (java.io.IOException e) {
	...
	public void writeWithCharsetEncTest() throws IOException {
		try {
			File file = folder.newFile();
			FileUtility.write(file, "", Charset.defaultCharset());
		} catch (java.io.IOException e) {
	...
	public void writeWithCharsetEncAndAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			FileUtility.write(file, "", Charset.defaultCharset(), false);
		} catch (java.io.IOException e) {
	...
	public void writeWithStringEncAndAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			FileUtility.write(file, "", "UTF-8", false);
		} catch (java.io.IOException e) {
	...
	public void writeByteArrayToFileTest() throws IOException {
		try {
			...
			FileUtility.writeByteArrayToFile(file, data);
		} catch (java.io.IOException e) {
	...
	public void writeByteArrayToFileWithAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			byte[] data = new byte[2];
			FileUtility.writeByteArrayToFile(file, data, false);
		} catch (java.io.IOException e) {
	...
	public void writeByteArrayToFileWithOffsetTest() throws IOException {
		try {
			File file = folder.newFile();
			byte[] data = new byte[2];
			FileUtility.writeByteArrayToFile(file, data, 0, 1);
		} catch (java.io.IOException e) {
	...
	public void writeByteArrayToFileWithOffsetAndAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			byte[] data = new byte[2];
			FileUtility.writeByteArrayToFile(file, data, 0, 1, false);
		} catch (java.io.IOException e) {
	...
	public void writeLinesTest() throws IOException {
		try {
			...
			FileUtility.writeLines(file, lines);
	...
	public void writeLinesWithAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			Collection<String> lines = new ArrayList<String>();
			FileUtility.writeLines(file, lines, false);
	...
	public void writeLinesWithAppendAndLineEndingAndEncTest() throws IOException {
		try {
			File file = folder.newFile();
			Collection<String> lines = new ArrayList<String>();
			FileUtility.writeLines(file, "UTF-8", lines, null, false);
	...
	public void writeLinesWithLineEndingTest() throws IOException {
		try {
			File file = folder.newFile();
			Collection<String> lines = new ArrayList<String>();
			FileUtility.writeLines(file, lines, null);
	...
	public void writeLinesWithLineEndingAndEncTest() throws IOException {
		try {
			File file = folder.newFile();
			Collection<String> lines = new ArrayList<String>();
			FileUtility.writeLines(file, "UTF-8", lines, null);
	...
	public void writeLinesWithEncTest() throws IOException {
		try {
			File file = folder.newFile();
			Collection<String> lines = new ArrayList<String>();
			FileUtility.writeLines(file, "UTF-8", lines);
	...
	public void writeLinesWithEncAndAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			Collection<String> lines = new ArrayList<String>();
			FileUtility.writeLines(file, "UTF-8", lines, false);
	...
	public void writeLinesWithLineEndingAndAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			Collection<String> lines = new ArrayList<String>();
			FileUtility.writeLines(file, lines, null, false);
	...
	public void writeStringToFileTest() throws IOException {
		try {
			...
			FileUtility.writeStringToFile(file, data, Charset.defaultCharset());
		} catch (java.io.IOException e) {
	...
	public void writeStringToFileWithStringEncAndAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			String data = "sampleData";
			FileUtility.writeStringToFile(file, data, "UTF-8", false);
		} catch (java.io.IOException e) {
	...
	public void writeStringToFileWithStringEncTest() throws IOException {
		try {
			File file = folder.newFile();
			String data = "sampleData";
			FileUtility.writeStringToFile(file, data, "UTF-8");
		} catch (java.io.IOException e) {
	...
	public void writeStringToFileWithAppendTest() throws IOException {
		try {
			File file = folder.newFile();
			String data = "sampleData";
			FileUtility.writeStringToFile(file, data, Charset.defaultCharset(), false);
		} catch (java.io.IOException e) {
